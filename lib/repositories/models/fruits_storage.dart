  ...
  static const String _favoriteFruitsKey = 'favorite_fruits';
    ...
    static Future<List<Map<String, dynamic>>> getFavoriteFruitsWithDetails(List<int> fruitIds) async {
      return fruitIds.map((fruitId) => {'id': fruitId, 'name': 'Фрукт $fruitId'}).toList();
    }
